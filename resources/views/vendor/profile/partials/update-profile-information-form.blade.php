<section>
    ...
    <form method="post" action="{{ route('vendorProfile.update') }}" class="mt-6 space-y-6">
        @csrf
        @method('patch')

        <div class="form-group">
            <x-input-label for="name" :value="__('Name')" class="profile-label" />
            <x-text-input id="name" name="name" type="text" class="profile-input mt-1 block w-full" :value="old('name', $user->name)" required autocomplete="name" />
