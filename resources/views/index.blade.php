...
<div class="content-container">
  ...
  <div class="container-fluid">
    <div class="row-offers">
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          ...
          <div class="card-body-offers">
            ...
            <p class="card-title">Buy 1 Get Another with 50% Off</p>
          </div>
          <div class="card-body-offers">
            <a href="#" class="button-offers">View More</a>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          ...
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Beauty and care</li>
            </ul>
            <p class="card-title">Buy 1 Get Another with 50% Off</p>
          </div>
          <div class="card-body-offers">
...
<!-- Pic Your Styles heading starts -->
<div class="content-container">
  ...
  <div class="container-fluid">
    <div class="row-offers">
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/A.jpg')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Diary Products</li>
            </ul>
      ...
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/C.webp')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Beauty and care</li>
            </ul>
      ...
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/D.webp')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Watches</li>
            </ul>
      ...
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/E.webp')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Mobile Accessories</li>
            </ul>
      ...
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/F.webp')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Foot wears</li>
            </ul>
      ...
      <div class="col-6 col-sm-4 col-md-2 offers-col">
        <div class="card-offers">
          <img class="card-img-top img-fluid" src="{{asset('img/top deals/G.webp')}}" alt="Offer Products">
          <div class="card-body-offers">
            <ul class="list-group list-group-flush">
              <li class="list-group-item">Bags</li>
            </ul>
      ...
      <div class="deals-block">
        ...
        <div class="deals-item">
          ...
          <div class="deal-action">
            <a href="#" class="deal-link">View More</a>
          </div>
          </div>
        </div>
        <div class="deals-item">
